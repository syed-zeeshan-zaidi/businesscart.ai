...
package com.businesscart.android.databinding;
...
public final class ActivityRegistrationBinding implements ViewBinding {
  ...
  private ActivityRegistrationBinding(@NonNull ConstraintLayout rootView, @NonNull EditText email,
      @NonNull EditText name, @NonNull EditText password, @NonNull EditText phone,
  ...
  public static ActivityRegistrationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegistrationBinding((ConstraintLayout) rootView, email, name, password,
          phone, register);
    }
