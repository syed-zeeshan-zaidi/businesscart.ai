    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="flex items-end justify-around h-64">
        {[3, 5, 8, 9, 9, 7, 8, 4, 6, 9, 8, 5].map((h, i) => (
          <div key={i} className="w-12 bg-teal-700 rounded-t-lg" style={{ height: `${h * 1.5}rem` }}></div>
        ))}
      </div>
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow-lg flex items-center">
              <CurrencyDollarIcon className="h-12 w-12 text-teal-700 mr-4" />
              <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg flex items-center">
              <ShoppingCartIcon className="h-12 w-12 text-teal-700 mr-4" />
              <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg flex items-center">
              <CubeIcon className="h-12 w-12 text-teal-700 mr-4" />
              <div>
                <p className="text-sm text-gray-600">Total Products</p>
                {isLoading ? 
                  <div className="animate-spin h-6 w-6 border-2 border-teal-700 border-t-transparent rounded-full"></div> : 
                  <p className="text-2xl font-bold text-gray-800">{productCount ?? 0}</p>
                }
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg flex items-center">
              <UsersIcon className="h-12 w-12 text-teal-700 mr-4" />
              <div>
