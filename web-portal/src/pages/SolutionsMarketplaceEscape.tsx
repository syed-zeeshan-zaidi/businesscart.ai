        ...
        <section className="py-16 bg-gradient-to-br from-gray-900 to-gray-800">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-8 text-sm text-gray-400">
              Available on <span className="text-white font-semibold">Growth</span> and <span className="text-white font-semibold">Enterprise</span> tiers.{' '}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-3">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col ring-2 ring-teal-700">
                ...
                <ul className="mt-6 space-y-3 flex-grow">
                  {['Everything in Starter', 'All payment gateways', 'Multiple locations', 'Quote workflow', 'AI add-on: $99/mo (basic)'].map((i) => (
                    <li key={i} className="flex items-start">
                      <CheckIcon className="h-5 w-5 text-teal-700 mt-0.5 flex-shrink-0" />
                      <span className="ml-3 text-base text-gray-700">{i}</span>
                    </li>
